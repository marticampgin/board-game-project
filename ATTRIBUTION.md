...
Short UI and event tones are generated mathematically in `scripts/services/preferences.gd`; they have no external asset dependency. Every cue also has a visible text indication.
